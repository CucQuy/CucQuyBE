...
(async () => {
  ...
  for (const o of await docs('orders')) {
    ...
    await ins('orders', { id: o.id, order_number: x(o.orderNumber), order_date: dt(o.orderDate), customer_id: cust.id && customerIds.has(cust.id) ? cust.id : null, customer_name: x(o.customerName), phone: x(o.phone), address: x(o.address), email: x(o.email), customer_city: x(cust.city), customer_country: x(cust.country), subtotal: x(o.subtotal), shipping_cost: x(o.shippingCost), discount_amount: x(o.discountAmount), total: x(o.total), payment_status: x(o.paymentStatus), payment_method: x(o.paymentMethod), status: x(o.status), delivery_type: x(o.deliveryType), delivery_date: x(o.deliveryDate), delivery_time: x(o.deliveryTime), note: x(o.note), sepay_id: o.sepayId == null ? null : String(o.sepayId), commission_status: x(o.commissionStatus), commission_paid_at: dt(o.commissionPaidAt), is_test: x(o.isTest), created_by: x(o.createdBy), updated_by: x(o.updatedBy), created_at: dt(o.createdAt), updated_at: dt(o.updatedAt) });
    bump('orders');
